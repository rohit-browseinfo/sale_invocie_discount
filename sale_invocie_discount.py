...
class account_invoice(osv.osv):
    ...
    def onchange_payment_term(self, cr, uid, ids, payment_term , context=None):
        #res = {}
        print "\n\n=====",payment_term,ids
        payment_term_id = self.pool.get('account.payment.term').browse(cr,uid,payment_term,context=context)
        #res.update({'discount_amount':payment_term_id.discount})
        #self.write(cr,uid,ids,{'discount_amount':payment_term_id.discount},context=context)
        return {'value': {'discount_amount': payment_term_id.discount or False}}
